...
<div class="form">
      ...
      <form:input type="number" class="form-control" path="number" placeholder="Enter phone number" class="form-control" pattern="[0-9]{3,}" title="not allowed character" required="true"/>
    </div></br></br>
